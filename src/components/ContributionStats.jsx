        ...
        <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-lg border border-white/15 bg-white/10 p-4 backdrop-blur">
              ...
              <p className="mt-1 text-sm text-white/70">đồng</p>
            </div>

            <button
              type="button"
              onClick={onShowContributors}
              className="group rounded-lg border border-white/15 bg-white/10 p-4 text-left backdrop-blur transition hover:border-heritage-gold/50 hover:bg-white/15 focus-visible:outline focus-visible:outline-2 focus-visible:outline-heritage-gold"
            ...
            >
              ...
              <p className="mt-1 flex items-center justify-between gap-2 text-sm text-white/70">
                người đã đóng góp
